...
<html lang="en">
    <head>
        <title>Template | Phoenix Force Robotics - FRC 2097</title>
    ...
    <body>
        <header>
            ...
            <p>
                ...
                <?php
                echo __FILE__;
                ?>, which is the template page; enjoy your stay!</i>
            </p>
        </header>
        ...
        <div class="sidebar">
            ...
            <nav class="nav" id="myTopnav">
                <a href="https://web-students.net/site66/fp/index.php" class="active">Home</a>
        ...
        <div class="wrapper">
            <h2 class="subheader">Test Article</h2>
