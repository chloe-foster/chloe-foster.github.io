...
<html lang="en">
    <head>
        <title>Our Sponsors | Phoenix Force Robotics - FRC 2097</title>
    ...
    <body>
        <header>
            ...
            <p>
                ...
                <?php
                echo __FILE__;
                ?>, which is the sponsor list page; enjoy your stay!</i>
            </p>
        </header>
        ...
        <div class="sidebar">
            ...
            <nav class="nav" id="myTopnav">
                ...
                <a href="https://web-students.net/site66/fp/sponsors.php" class="active">Sponsors</a>
        ...
        <div class="wrapper">
            <h2 class="subheader">Our Sponsors</h2>

            <img src="https://picsum.photos/200/300" alt="A sponsor">
            <img src="https://picsum.photos/200/300" alt="Another sponsor">
            <img src="https://picsum.photos/200/300" alt="A third sponsor">
