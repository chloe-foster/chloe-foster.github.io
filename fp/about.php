...
<html lang="en">
    <head>
        <title>About | Phoenix Force Robotics - FRC 2097</title>
    ...
    <body>
        <header>
            ...
            <p>
                ...
                <?php
                echo __FILE__;
                ?>, which is the about us page; enjoy your stay!</i>
            </p>
        </header>
        ...
        <div class="sidebar">
            ...
            <nav class="nav" id="myTopnav">
                ...
                <a href="https://web-students.net/site66/fp/about.php" class="active">About</a>
        ...
        <div class="wrapper">
            <h2 class="subheader">About our team</h2>
