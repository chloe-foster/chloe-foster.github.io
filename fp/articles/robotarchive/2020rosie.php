...
<html lang="en">
    <head>
        <title>2020 - Rosie | Phoenix Force Robotics - FRC 2097</title>
    ...
    <body>
        <header>
            ...
            <p>
                ...
                <?php
                echo __FILE__;
                ?>, which is a robot archive article; enjoy your stay!</i>
            </p>
        </header>
        ...
        <div class="wrapper">
            <h2 class="subheader">2020 - Rosie</h2>
            <h3><i>Live every moment as though it were your last.</i></h3>

            <a href="../archiveindex.php">Return to Robot Archive<a>
