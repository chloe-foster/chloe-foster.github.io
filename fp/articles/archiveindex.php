...
<html lang="en">
    <head>
        <title>Archive | Phoenix Force Robotics - FRC 2097</title>
    ...
    <body>
        <header>
            ...
            <p>
                ...
                <?php
                echo __FILE__;
                ?>, which is the archive index page; enjoy your stay!</i>
            </p>
        </header>
        ...
        <div class="sidebar">
            ...
            <nav class="nav" id="myTopnav">
                ...
                <a href="https://web-students.net/site66/fp/articles/archiveindex.php" class="active">Archive</a>
        ...
        <div class="wrapper">
            <h2 class="subheader">Archive Index</h2>
            
            <p>All previous publicly-available updates, plus all the info we have on our old robots.</p>

            <nav>
                <h2>All Archived Updates</h2>
                <a href="https://web-students.net/site66/fp/articles/archivedupdates/1-1-2000.php">1-1-2000</a>
            </nav>
            <nav>
                <h2>All Robots</h2>
                <a href="https://web-students.net/site66/fp/articles/robotarchive/2020rosie.php">2020 - Rosie</a>
            </nav>
            <footer>
                <p>
                    <small>
